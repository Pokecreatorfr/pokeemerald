static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_MAYS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_MAYS_HOUSE_2F), 5, 4},
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(TOWN), MAP_NUM(TOWN), 13, 7},
