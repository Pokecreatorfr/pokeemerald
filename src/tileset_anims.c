...
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step0[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/1.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step1[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/2.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step2[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/3.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step3[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/4.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step4[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/5.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step5[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/6.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step6[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/7.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step7[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/8.4bpp" );

const u16 * const gTilesetAnims_4g_tileset_Waterfall_Anim_Part1[] = {
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step7,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step0,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step1,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step2,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step3,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step4,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step5,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step6,
};

const u16 * const gTilesetAnims_4g_tileset_Waterfall_Anim_Part2[] = {
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step3,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step4,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step5,
    gTilesetAnims_4g_tileset_exterior_Waterfall_Anim_Step6,
...
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim0[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/1.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim1[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/2.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim2[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/3.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim3[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/4.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim4[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/5.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim5[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/6.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim6[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/7.4bpp" );
const u16 gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim7[] = INCBIN_U16( "data/tilesets/primary/4g_tileset_exterior/anim/waterfall/steam/8.4bpp" );

const u16 * const gTilesetAnims_4g_tileset_Waterfallsteam_Anim[] = {
    gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim0,
    gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim1,
    gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim2,
    gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim3,
    gTilesetAnims_4g_tileset_exterior_Waterfallsteam_Anim4,
...
static void TilesetAnim_4g_tileset_exterior(u16 timer)
{
    ...
    if (timer % 8 == 0)
        QueueAnimTiles__4g_tileset_Waterfall_Anim_Part1(timer / 8);
    if (timer % 8 == 0)
...
static void QueueAnimTiles__4g_tileset_Waterfall_Anim_Part1(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_4g_tileset_Waterfall_Anim_Part1); 
    AppendTilesetAnimToBuffer(gTilesetAnims_4g_tileset_Waterfall_Anim_Part1[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(0x1ce)), 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles__4g_tileset_Waterfall_Anim_Part2(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_4g_tileset_Waterfall_Anim_Part2); 
    AppendTilesetAnimToBuffer(gTilesetAnims_4g_tileset_Waterfall_Anim_Part2[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(0x1de)), 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles__4g_tileset_Waterfallsteam_Anim(u16 timer)
{
